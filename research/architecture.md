...
The next steps for this system include the handling of alignment, authentication, and recovery.
...
Authentication management is also essential to allow for use in real-world enterprise applications.
It would allow for managment by YARN or other systems to handle firewall restrictions and the like.
